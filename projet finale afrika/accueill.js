...
function addCartClicked(event) {
  ...
  var title = shopProducts.getElementsByClassName("product-titel")[0].innerText;
...
function addProductToCart(title, price, productImg) {
  ...
  cartShopBox
    ...
    .addEventListener("change", qunatityChanged);
}
// Update Total
function updatetotal() {
  ...
  for (var i = 0; i < cartBoxes.length; i++) {
    ...
    var price = parseFloat(priceElement.innerText.replace("fca", ""));
  ...
  document.getElementsByClassName("total-price")[0].innerText = "fca" + total;
}
